    ...
    return (
        <div>
            <div className="front-text">
                ...
                <h6>But as a true blog we want to tell you about our process making this. So if you want to know more of the valuable lessons we've learned, do scroll down!</h6>
            </div>
            <hr></hr>
            <div className="front-page-wrapper">
                <div class="front-card" >
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">How much we can do with CSS and how straightforward it is.</p>
                    </div>
                </div>
                ...
                <div class="front-card" >
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">We have definitely learned that JavaScript always makes sense!</p>
                    </div>
                </div>
                ...
                <div class="front-card" >
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">The simple and beautiful process of debuggin our code. A pretty process that is definitely suitable to be shared!</p>
                    </div>
                </div>
            </div>
        </div>
